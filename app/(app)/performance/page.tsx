...
export default function PerformancePage() {
  ...
  const openingDayProductivity = allMonthsTotal.workDays > 0 && allMonthsTotal.openingCount > 0
    ? Math.round((allMonthsTotal.openingCount / allMonthsTotal.workDays) * 100) / 100 : null
                ...
                <div key={r.id} className="bg-white rounded-2xl shadow-sm ring-1 ring-gray-100 overflow-hidden">
                  ...
                  <div className="px-5 py-4">
                    <div className="grid grid-cols-3 gap-2 bg-gray-50 rounded-xl p-3">
                      ...
                      <div className="text-center">
                        <p className="text-xs text-gray-400 mb-0.5">稼働生産性</p>
                        <p className="text-sm font-bold text-blue-500">
                          {openingDayProductivity != null ? <>{openingDayProductivity}<span className="text-xs font-normal text-gray-400 ml-0.5">件/日</span></> : '-'}
                        </p>
                      </div>
                    </div>
