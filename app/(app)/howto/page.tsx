...
const MANAGER_EXTRA_SECTIONS: Section[] = [
  {
    ...
    items: [
      ...
      { label: '全体タブ', desc: '年別に全体の月次獲得・解除数を管理します。各月の鉛筆アイコンで数値・人数・メモを編集できます。' },
    ],
  },
  {
    title: 'チーム全体',
  ...
  },
  {
    ...
    items: [
      ...
      { label: '個人進捗ページでメンバー切り替え', desc: '個人進捗ページ上部のメンバーボタンを切り替えると、特定メンバーの目標・実績・アド/ビハを確認できます。閲覧中は自分の目標の保存ボタンは非表示になります。' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: '反映ルール', desc: '解除⭕️かつ工事日・受取日・開通予定日が確定している案件のみ開通カレンダーに表示されます。「未定」「-」の日付は表示されません。入力した月ではなく、実際の工事日・受取日が属する月のカレンダーに反映されます。' },
    ],
  },
  {
    title: '通知送信',
