...
const MEMBER_SECTIONS: Section[] = [
  ...
  },
  {
    ...
    items: [
      { label: '出欠を入力する', desc: '毎週金曜のMTGに対して「出席」「欠席」「遅刻」のいずれかを選択します。欠席・遅刻の場合は理由の入力が必須です。' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: '秘伝書タブ', desc: 'テキストを直接貼り付けて投稿できるタブです。「秘伝書を投稿」ボタンからタイトルと内容を入力して保存します。一覧では冒頭2行のプレビューが表示され、▼で全文を展開できます。' },
